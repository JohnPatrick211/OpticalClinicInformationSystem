                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <br><br>
                                    <div class="h6 mb-0 font-weight-bold text-gray-800"><a href="doctor-appointment-list">Click Here to See More</a></div>
                                    </div>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h3 mb-0 font-weight-bold text-gray-800">{{ $pendingappointmentapproval}}
                                        <br><br>
                                    <div class="h6 mb-0 font-weight-bold text-gray-800"><a href="doctor-appointment-approval">Click Here to See More</a></div>
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <i class="fas fa-history fa-3x text-gray-400"></i>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h3 mb-0 font-weight-bold text-gray-800">{{ $completeappointment }}
                                     <br><br>
                                    <div class="h6 mb-0 font-weight-bold text-gray-800"><a href="doctor-appointment-reports">Click Here to See More</a></div></div>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h3 mb-0 font-weight-bold text-gray-800">{{$pendingpatient}}
                                     <br><br>   
                                    <div class="h6 mb-0 font-weight-bold text-gray-800"><a href="doctor-patient-approval">Click Here to See More</a></div></div>
                                </div>
                                <div class="col-auto">
                                    <i class="fas fa-history fa-3x text-gray-400"></i>
                                </div>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h3 mb-0 font-weight-bold text-gray-800"><span style="font-size: 28px;">&#8369;</span> {{number_format($sales, 2, '.',',')}}
                                     <br><br>   
                                    <div class="h6 mb-0 font-weight-bold text-gray-800"><a href="doctor-sales-reports">Click Here to See More</a></div></div>
                                </div>
                                <div class="col-auto">
