        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="patient-dashboard">
                    ...
                    <span id="content-dashboard">My Profile</span></a>
            </li>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseApproval" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="patient-my-appointment">My Appointment</a>
                        <a class="collapse-item" href="patient-book-appointment">Book Appointment</a>
                    </div>
                </div>
            </li>
