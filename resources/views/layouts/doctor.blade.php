...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseApproval" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="doctor-billing">Billing</a>
                        <a class="collapse-item" href="doctor-inventory">Inventory</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseMaintenance" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="doctor-maintenance-service">Service Maintenance</a>
                        <a class="collapse-item" href="doctor-maintenance-product">Product Maintenance</a>
   ...
   <script src="js/datatables-demo.js"></script>
    ...
    <script src="js/doctorpatienthistory.js"></script>
    <script src="js/doctorpatientprescription.js"></script>
