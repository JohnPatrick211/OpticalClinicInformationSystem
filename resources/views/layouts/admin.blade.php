        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePatientApproval" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="patient-information">Patient Information</a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="services-reports">Service Reports</a>
                        <a class="collapse-item" href="appointment-reports">Appointment Report</a>
                        <a class="collapse-item" href="certification-reports">Certification Report</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseMaintenance" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="maintenance-service">Service Maintenance</a>
                        <a class="collapse-item" href="maintenance-product">Product Maintenance</a>
                        <a class="collapse-item" href="maintenance-categoryproduct">Category Maintenance</a>
                        <a class="collapse-item" href="maintenance-discount">Discount Maintenance</a>
                        <a class="collapse-item" href="maintenance-schedule">Schedule Maintenance</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="maintenance-branch">Branch Maintenance</a>
