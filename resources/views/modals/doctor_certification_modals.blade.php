  ...
  <!-- Edit Modal -->
  @yield('doctorcertificationmodal')
<div class="modal fade" id="DoctorCertificationModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
