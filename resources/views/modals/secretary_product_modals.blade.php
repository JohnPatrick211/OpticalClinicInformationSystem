...
<!-- Add Product -->
  ...
  <!-- Edit Modal -->
  @yield('productmodal')
<div class="modal fade" id="SecretaryProductModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form action="storeproduct" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <input class="form-control form-control-navbar" name="productbranch" id="productbranch" type="hidden" value="{{$LoggedUserInfo -> branch_id}}" aria-label="Search" >
                  <input class="form-control form-control-navbar" name="displayproductbranch" id="displayproductbranch" type="text" value="{{$users6->branchname}}" aria-label="Search" disabled>
                  </div>
...
<div class="modal fade" id="SecretaryEditProductModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="row justify-content-center">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <input class="form-control form-control-navbar" name="editproductbranch" id="editproductbranch" type="hidden" value="{{$LoggedUserInfo -> branch_id}}" aria-label="Search" disabled>
                  <input class="form-control form-control-navbar" name="displayeditproductbranch" id="displayeditproductbranch" type="text" value="{{$users6->branchname}}" aria-label="Search" disabled>
                  </div>
