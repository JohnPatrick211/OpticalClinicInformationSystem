...
class AppointmentListController extends Controller
{
    ...
    public function DoctorAppointmentListView(){
        if(Session::has('LoggedUser')){
            $users2 = DB::table('tbl_user')->where('id','=', session('LoggedUser'))->first();
            $users4 = ClinicBranch::orderBy('id', 'ASC')->get();
            $users5 = Login::orderBy('id', 'ASC')->where('user_role','=','Doctor')->get();
            ...
            $data = [
             ...
             //$users3 = User::where('role','employer')->get();
             return view('doctor-appointment-list', $data)->with('users4',$users4)->with('users5',$users5);


         }
    }
    public function SecretaryAppointmentListView(){
        if(Session::has('LoggedUser')){
            $users2 = DB::table('tbl_user')->where('id','=', session('LoggedUser'))->first();
            $users4 = ClinicBranch::orderBy('id', 'ASC')->get();
            ...
            $data = [
             ...
             //$users3 = User::where('role','employer')->get();
             return view('secretary-appointment-list', $data)->with('users4',$users4)->with('users5',$users5);
