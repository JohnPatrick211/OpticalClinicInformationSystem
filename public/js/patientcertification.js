$(document).ready(function(){
    $.ajaxSetup({
      ...
      fetchPatientCertification();

      function fetchPatientCertification(){

      var tbl_for_validation = $('#datatable-patientcertificate').DataTable({

          processing: true,
          serverSide: true,

          ajax:{
           url: "patientcertification-data",
          },
      ...
      $(document).on('click', '#btn-preview-certificate', function(){
        var id = $(this).attr('employer-id');
        console.log(id);
        fetchCertificationInfo(id);
      });

      function fetchCertificationInfo(id){
        $.ajax({
          url:"/patientcertification/getpatientcertificationinfo/"+ id,
          type:"GET",
          ...
          success:function(data){
            ...
            window.open('previewcertification/print/'+id+'/'+patient_id+'/'+doctor_id+'/'+branch_id, '_blank');
          }
