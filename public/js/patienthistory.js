$(document).ready(function(){
    $.ajaxSetup({
      ...
      var tbl_for_validation = $('#datatable-patienthistory').DataTable({

          processing: true,
          serverSide: true,

          ajax:{
           url: "patienthistory-data",
          },
   ...
   $('#select-all').on('click', function(){
    ...
    $('#for-validation-table tbody').on('change', 'input[type="checkbox"]', function(){
      ...
      function fetchHistoryInfo(invoice_no){
        $.ajax({
          url:"/patienthistory/getpatienthistoryinfo/"+ invoice_no,
          type:"GET",
          ...
          success:function(data){
            ...
            window.open("patienthistory/preview-invoice/"+wholesale_discount_amount +"/"+senior_pwd_discount_amount+"/"+billingbranch+"/"+patientname+"/"+invoice_no);
          }
