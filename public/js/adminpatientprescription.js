$(document).ready(function(){
    $.ajaxSetup({
      ...
      function load_data(){
        let patientprescriptionbranch = $('#patientprescriptionbranch').val()
        fetchPatientPrescription(patientprescriptionbranch);
      }

      function fetchPatientPrescription(patientprescriptionbranch){

      var tbl_for_validation = $('#datatable-adminpatientprescription').DataTable({

          processing: true,
          serverSide: true,

          ajax:{
           url: "adminpatientprescription-data",
           data:{
            patientprescriptionbranch:patientprescriptionbranch,
           },
          },
      ...
      $('#patientprescriptionbranch').change(function()
      {
        let patientprescriptionbranch = $('#patientprescriptionbranch').val()
        $('#datatable-adminpatientprescription').DataTable().destroy();
        fetchPatientPrescription(patientprescriptionbranch);
      });
      ...
      function fetchPrescriptionInfo(id){
        $.ajax({
          url:"/adminpatientprescription/getpatientprescriptioninfo/"+ id,
          type:"GET",
          ...
          success:function(data){
            ...
            window.open("adminpatientprescription/preview-prescription/"+doctorname +"/"+branchname+"/"+date+"/"+time+"/"+patient_id+"/"+prescription);
          }
