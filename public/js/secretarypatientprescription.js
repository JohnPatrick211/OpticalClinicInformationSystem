$(document).ready(function(){
    $.ajaxSetup({
      ...
      var tbl_for_validation = $('#datatable-secretarypatientprescription').DataTable({

          processing: true,
          serverSide: true,

          ajax:{
           url: "secretarypatientprescription-data",
          },
      ...
      function fetchPrescriptionInfo(id){
        $.ajax({
          url:"/secretarypatientprescription/getpatientprescriptioninfo/"+ id,
          type:"GET",
          ...
          success:function(data){
            ...
            window.open("secretarypatientprescription/preview-prescription/"+doctorname +"/"+branchname+"/"+date+"/"+time+"/"+patient_id+"/"+prescription);
          }
