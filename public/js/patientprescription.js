$(document).ready(function(){
    $.ajaxSetup({
      ...
      var tbl_for_validation = $('#datatable-patientprescription').DataTable({

          processing: true,
          serverSide: true,

          ajax:{
           url: "patientprescription-data",
          },
      ...
      function fetchPrescriptionInfo(id){
        $.ajax({
          url:"/patientprescription/getpatientprescriptioninfo/"+ id,
          type:"GET",
          ...
          success:function(data){
            ...
            window.open("patientprescription/preview-prescription/"+doctorname +"/"+branchname+"/"+date+"/"+time+"/"+patient_id+"/"+prescription);
          }
