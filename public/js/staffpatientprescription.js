$(document).ready(function(){
    $.ajaxSetup({
      ...
      var tbl_for_validation = $('#datatable-staffpatientprescription').DataTable({

          processing: true,
          serverSide: true,

          ajax:{
           url: "staffpatientprescription-data",
          },
      ...
      function fetchPrescriptionInfo(id){
        $.ajax({
          url:"/staffpatientprescription/getpatientprescriptioninfo/"+ id,
          type:"GET",
          ...
          success:function(data){
            ...
            window.open("staffpatientprescription/preview-prescription/"+doctorname +"/"+branchname+"/"+date+"/"+time+"/"+patient_id+"/"+prescription);
          }
