$(document).ready(function(){
    $.ajaxSetup({
      ...
      var tbl_for_validation = $('#datatable-doctorpatienthistory').DataTable({

          processing: true,
          serverSide: true,

          ajax:{
           url: "doctorpatienthistory-data",
          },
   ...
   $('#select-all').on('click', function(){
    ...
    $('#for-validation-table tbody').on('change', 'input[type="checkbox"]', function(){
      ...
      function fetchHistoryInfo(invoice_no){
        $.ajax({
          url:"/doctorpatienthistory/getpatienthistoryinfo/"+ invoice_no,
          type:"GET",
          ...
          success:function(data){
            ...
            window.open("doctorpatienthistory/preview-invoice/"+wholesale_discount_amount +"/"+senior_pwd_discount_amount+"/"+billingbranch+"/"+patientname+"/"+invoice_no);
          }
